...
def create_app():
    ...
    if ENV == 'dev':
        ...
        app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://vcoibczjbx:H2D8UYTZ582Z3OOU$@troologdemo-server.postgres.database.azure.com/rtroologdemo-database?sslmode=require'

...
def configurations():
    ...
    insta_login = "https://www.facebook.com/v16.0/dialog/oauth?client_id=" + app_id + "&display=page&extras={\"setup\":{\"channel\":\"PARTNER\"}}&redirect_uri=https://troolog.azurewebsites.com/instaconfiguration&response_type=token&scope=instagram_basic,instagram_manage_messages,pages_manage_metadata"
